// Đặt tại: com.example.tour_service.repository.TourSpecification.java
...
public class TourSpecification {
    ...
    /**
     * LƯU Ý QUAN TRỌNG:
     * Các chuỗi "destinationLocation", "departureLocation", "departureDate", "basePrice"
     * phải TRÙNG KHỚP 100% với tên các trường (field) trong Entity `Tour`
     */
